...
- [ ] remove coupling with handlebars (should not assume data is consumed only by handlebars).. only
...
* [ddata](#module_ddata)
  ...
  * [._link(input, options)](#module_ddata._link) ⇒ <code>Object</code>
...
### ddata._link(input, options) ⇒ <code>Object</code>
