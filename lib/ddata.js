...
function _link(longname, options){
    var linked;
    var outputContext = {};

    options.hash = { id: longname };
    linked = identifier(options);
    // console.error(linked)
    if (!linked){
        options.hash = { longname: longname };
        linked = identifier(options);
    }
    if (linked){
        ...
        outputContext = { name: longname, url: null };
    }
    // console.error(longname)
    // console.error(outputContext)
